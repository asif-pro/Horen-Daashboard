...
function Widget({title, children}) {
  ...
  function Graph({ percentage, options}) {
    const [rotateValue, setRotateValue] = React.useState([-127, 100])
                 ...
                 <svg  width="0" height="0" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <clipPath id="bgClipping" clipPathUnits="objectBoundingBox" transform="scale(0.0023640661938 0.00250626566)">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M13 211H43H63.7154H359.285H371H410C417.18 211 423.042 205.164 422.605 197.998C415.873 87.5214 323.932 0 211.5 0C99.0684 0 
    7.12695 87.5214 0.394988 197.998C-0.0416884 205.164 5.82031 211 13 211Z" fill="teal"/>
                    </clipPath>
                </defs>
              </svg>
                 <div className='coloredDisplay'>
                    ...
                    <path class='leftCurve' fill-rule="evenodd" clip-rule="evenodd" d="M105.598 112.649C60.9264 160.99 61.1432 234.825 104.225 282.86C108.651 287.794 109.003 295.354 104.505 300.221L71.9279 335.474C67.4299 340.341 59.8024 340.659 55.2114 335.879C-16.9874 260.712 -18.949 141.338 52.7197 63.7836C124.388 -13.7709 243.545 -21.2177 324.166 44.8364C329.293 49.0366 329.577 56.6655 325.079 61.5328L292.502 96.7853C288.004 101.653 280.44 101.897 275.173 97.8741C223.894 58.7091 150.27 64.3085 105.598 112.649Z" fill="teal"/>
                    <path class='rightCurve' fill-rule="evenodd" clip-rule="evenodd" d="M293.116 285.459C337.666 237.006 337.263 163.171 294.06 115.245C289.623 110.322 289.251 102.763 293.737 97.8848L326.225 62.5503C330.711 57.6717 338.337 57.3345 342.94 62.1026C415.328 137.088 417.591 256.456 346.118 334.191C274.645 411.926 155.507 419.673 74.7195 353.822C69.5824 349.635 69.2795 342.007 73.7651 337.128L106.253 301.794C110.739 296.915 118.302 296.652 123.579 300.661C174.957 339.697 248.566 333.912 293.116 285.459Z" fill="red"/>
                </svg>     
                 </div> 
             </div>
              <div className='dial'>
...
const Guage = () => {
    ...
    return (
      <>
        ...
        <Widget width="100%" title=''>  
          <p>Horn Quota</p>
          
          <Graph percentage={percentage} options={['Used', 'Left']}/>
        </Widget>
      </>
    );
  }; 
